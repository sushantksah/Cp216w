...
// This version doesn't work as it doesn't preserve the LR,
// causing the code to return the wrong address. 
...
_isLetterEnd:
ldmfd   sp!, {lr} // Load from stack, and restore LR 
bx      lr

// This is fixed by utilizing stmfd, and ldmfd that load 
// and store registers on the stack, ensuring proper call
// flow
//=======================================================
