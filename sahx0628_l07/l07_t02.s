...
//=======================================================
// Two pointer approach, one at back one at front
stmfd   sp!, {r4-r6, lr}

// Check if front/back pointers crossed
cmp     r4, r5
bge     _PTrue

// Skip front non-letters
ldrb    r2, [r4]
bl      isLetter
cmp     r0, #0
beq     _SkipFront

// Skip back non-letters
ldrb    r2, [r5]
bl      isLetter
cmp     r0, #0
beq     _SkipBack

// Convert both to lowercase for easy comparison
ldrb    r2, [r4]
bl      toLower
mov     r6, r2
